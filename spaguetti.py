...
file = open("exp_rev/networkDefinition.json", "w")
...
file = open("exp_rev/appDefinition.json", "w")
...
file = open("exp_rev/usersDefinition.json", "w")
...
file = open("exp_rev/allocDefinition.json", "w")
...
if ILPoptimization:
    ...
    file = open("exp_rev/allocDefinitionILP.json", "w")
    file.write(json.dumps(allAlloc))
    file.close()
